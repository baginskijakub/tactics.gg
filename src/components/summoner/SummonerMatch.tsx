...
export const SummonerMatch: React.FC<Props> = ({
  placement,
  queueType,
  timeAgo,
  augments,
    ...
    <div className="summoner-match-wrapper">
      <div className="summoner-match-head">
        ...
        <div className="summoner-match-info-container">
          ...
          {traitLabel && (
            <div className="summoner-match-info-inner">
      ...
      {state && (
        <div className="summoner-match-expanded">
          <div className="summoner-match-expanded-titles">
            {!isMobile && (
              <h5 className="summoner-match-titles-placement">Placement</h5>
            )}
            {!isMobile && (
              <h5 className="summoner-match-titles-summoner">Summoner</h5>
            )}
            {!isMobile && (
              <h5 className="summoner-match-titles-eliminated">Eliminated</h5>
            )}
            {!isMobile && (
              <h5 className="summoner-match-titles-board">Board</h5>
            )}
            {!isMobile && (
              <h5 className="summoner-match-titles-gold">Gold left</h5>
            )}
            {isMobile && (
              <h5 className="summoner-match-titles-all">All players</h5>
            )}
          </div>

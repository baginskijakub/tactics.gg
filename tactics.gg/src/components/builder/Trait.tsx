...
export const Trait:React.FC<Props> = ({name, style, active, breakpoints}) => {
        ...
        <div className="builder-trait-container">
            <div className="trait-icon-container">
                <div className="hex" style={{backgroundColor : `${backgroundColor}`}}>
                    <img src={`https://ittledul.sirv.com/Images/traits/${name.toLowerCase()}.png`}></img>
                </div>
                <div className="hex-rectangle" style={{backgroundColor : `${backgroundColor}`}}>
                    <h5>{active}</h5>
                </div>
            </div>
            <div className="builder-trait-details">
                <h4>{name}</h4>
                <div className="builder-trait-details-inner">
                    {arr}
                </div>
            </div>
        </div>

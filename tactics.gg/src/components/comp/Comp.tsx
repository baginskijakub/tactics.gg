    ...
    <div className="comp-wrapper">
      <div className="comp-head-container">
        <div className="comp-head-inner">
          <div className="comp-traits">{traitList}</div>
          <div className="comp-units">{unitList}</div>
        </div>
      ...
      {state === "open" && (
        <div>
          ...
          {selected === "Positioning" && (
            <CompPositioning positioning={positioning} />
          )}
          {selected === "Items" && <CompItems units={items} />}
          {selected === "Augments" && <CompAugments augments={augments} />}
          {selected === "Variations" && (
            <CompVariations variations={variations} />
          )}
        </div>
      )}

...
export const SummonerStats:React.FC<Props> = ({played, wins, percentWins, top4, percentTop4, avgPlacement}) => {
            ...
            <div className="summoner-stats-container">
                <div className="summoner-stats-inner">
                        <div className="summoner-profile-bar-titles">
                            ...
                            <p className="body-small">{percentWins}% <span className="grey-text">({wins})</span></p>
                        </div>
                ...
                <div className="summoner-stats-inner">
                        <div className="summoner-profile-bar-titles">
                            ...
                            <p className="body-small">{percentTop4}% <span className="grey-text">({top4})</span></p>
                        </div>
                        <div className="summoner-profile-bar">

...
export const SummonerMatchRow:React.FC<Props> = ({placement, icon, name, roundEliminated, augments, traits, units, goldLeft}) => {
    ...
    return (
        <div className="summoner-match-row-wrapper">
            ...
            <div className="summoner-match-placement-summoner">
                <h4 className="summoner-match-row-placement">{placement}{placementEnd}</h4>
                <div className="summoner-match-row-summoner-container">
                    {!isMobile && <img src={icon} alt="summoner icon"/>}
                    <h5>{name}</h5>
                </div>
            </div>
            {!isMobile && <h5 className="summoner-match-row-eliminated">{roundEliminated}</h5>}
            ...
            {!isMobile && <div className="summoner-match-row-gold">
                <h5>{goldLeft}</h5>

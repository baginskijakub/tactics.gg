...
let SpearOfShoijn: Item = new Item(
  123,
  "Spear of Shoijn",
  "https://ittledul.sirv.com/Images/items/13.png"
);
let ArchangelStaff: Item = new Item(
  123,
  "Archangel Staff",
  "https://ittledul.sirv.com/Images/items/12.png"
);
let HextechGunblade: Item = new Item(
  123,
  "Hextech Gunblade",
  "https://ittledul.sirv.com/Images/items/24.png"
);
let GargoyleStoneplate: Item = new Item(
  123,
  "Gargoyle Stoneplate",
  "https://ittledul.sirv.com/Images/items/2024.png"
);
let Warmogs: Item = new Item(
  123,
  "Gargoyle Stoneplate",
  "https://ittledul.sirv.com/Images/items/13.png"
);
let SunfireCape: Item = new Item(
  123,
  "Gargoyle Stoneplate",
  "https://ittledul.sirv.com/Images/items/13.png"
);
...
let companion1: Companion = new Companion(
  1,
  icon,
  "baginski",
  "6-4",
...
let companion2: Companion = new Companion(
  2,
  icon,
  "woyak",
  "6-4",
...
let companion3: Companion = new Companion(
  3,
  icon,
  "NadimCoSięUmył",
  "6-2",
...
let companion4: Companion = new Companion(
  4,
  icon,
  "Hedrekao",
  "6-1",
...
let companion5: Companion = new Companion(
  5,
  icon,
  "simplywojtek",
  "5-5",
...
let companion6: Companion = new Companion(
  6,
  icon,
  "ANO shreddin",
  "5-5",
...
let companion7: Companion = new Companion(
  7,
  icon,
  "ANO Kezman",
  "5-4",
...
let companion8: Companion = new Companion(
  8,
  icon,
  "sh1rcane",
  "5-2",
